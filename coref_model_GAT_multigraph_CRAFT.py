...
class CorefModel(object):
    ...
    def restore(self, session):
        ...
        #checkpoint_path = os.path.join(self.config["log_dir"], "model-5398")
    ...
    def get_predictions_and_loss(self, tokens, context_word_emb, head_word_emb, lm_emb, bert_emb, char_index, text_len, is_training, gold_starts, gold_ends, cluster_ids, number_ids, MM_ids, OMCS_emb, organisms_emb, proteins_emb, mygenes_emb, genes_emb, interaction_types_emb,adj_emb,adj_emb_global,dep_emb,dep_emb_global):
        ...
        num_words = util.shape(lstm_gcnoutput, 0)
        ...
        dd1=dep_emb_reshape[:50,:,:]
        dd2=dep_emb_reshape[50:100,:,:]
        dd3=dep_emb_reshape[100:150,:,:]
        dd4=dep_emb_reshape[150:200,:,:]
        dd5=dep_emb_reshape[200:250,:,:]
        dd6=dep_emb_reshape[250:300,:,:]
        dd7=dep_emb_reshape[300:350,:,:]
        dd8=dep_emb_reshape[350:400,:,:]
        dd9=dep_emb_reshape[400:,:,:]
        '''
        kk1=KB_emb_tmp[:50*max_sentence_length,:]
        kk2=KB_emb_tmp[50*max_sentence_length:100*max_sentence_length,:]
        kk3=KB_emb_tmp[100*max_sentence_length:150*max_sentence_length,:]
        kk4=KB_emb_tmp[150*max_sentence_length:200*max_sentence_length,:]
        kk5=KB_emb_tmp[200*max_sentence_length:250*max_sentence_length,:]
        kk6=KB_emb_tmp[250*max_sentence_length:300*max_sentence_length,:]
        kk7=KB_emb_tmp[300*max_sentence_length:350*max_sentence_length,:]
        kk8=KB_emb_tmp[350*max_sentence_length:400*max_sentence_length,:]
        kk9=KB_emb_tmp[400*max_sentence_length:,:]
               
        '''
        with tf.variable_scope("GAT_local_1"):    
            gatoutput_local1=self.GAT_encode(aa1, dd1, kk1, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)            
        with tf.variable_scope("GAT_local_2"):    
            gatoutput_local2=self.GAT_encode(aa2, dd2, kk2, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        
        with tf.variable_scope("GAT_local_3"):    
            gatoutput_local3=self.GAT_encode(aa3, dd3, kk3, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_local_4"):    
            gatoutput_local4=self.GAT_encode(aa4, dd4, kk4, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_local_5"):    
            gatoutput_local5=self.GAT_encode(aa5, dd5, kk5, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_local_6"):    
            gatoutput_local6=self.GAT_encode(aa6, dd6, kk6, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_local_7"):    
            gatoutput_local7=self.GAT_encode(aa7, dd7, kk7, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_local_8"):    
            gatoutput_local8=self.GAT_encode(aa8, dd8, kk8, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_local_9"):    
            gatoutput_local9=self.GAT_encode(aa9, dd9, kk9, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
            
        gatoutput_local= self.flatten_emb_by_sentence(tf.concat([gatoutput_local1,gatoutput_local2,gatoutput_local3,gatoutput_local4,gatoutput_local5,gatoutput_local6,gatoutput_local7,gatoutput_local8,gatoutput_local9],0), text_len_mask) 
        ...
        aa1_global=A_tmp_global[:50,:,:]
        aa2_global=A_tmp_global[50:100,:,:]
        aa3_global=A_tmp_global[100:150,:,:]
        aa4_global=A_tmp_global[150:200,:,:]
        aa5_global=A_tmp_global[200:250,:,:]
        aa6_global=A_tmp_global[250:300,:,:]
        aa7_global=A_tmp_global[300:350,:,:]
        aa8_global=A_tmp_global[350:400,:,:]
        aa9_global=A_tmp_global[400:,:,:]
        
        dd1_global=dep_emb_reshape_global[:50,:,:]
        dd2_global=dep_emb_reshape_global[50:100,:,:]
        dd3_global=dep_emb_reshape_global[100:150,:,:]
        dd4_global=dep_emb_reshape_global[150:200,:,:]
        dd5_global=dep_emb_reshape_global[200:250,:,:]
        dd6_global=dep_emb_reshape_global[250:300,:,:]
        dd7_global=dep_emb_reshape_global[300:350,:,:]
        dd8_global=dep_emb_reshape_global[350:400,:,:]
        dd9_global=dep_emb_reshape_global[400:,:,:]

        
        
        with tf.variable_scope("GAT_global_1"):            
            gatoutput_global1=self.GAT_encode(aa1_global, dd1_global, kk1, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
            
        with tf.variable_scope("GAT_global_2"):        
            gatoutput_global2=self.GAT_encode(aa2_global, dd2_global, kk2, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
            
        with tf.variable_scope("GAT_global_3"):        
            gatoutput_global3=self.GAT_encode(aa3_global, dd3_global, kk3, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_global_4"):        
            gatoutput_global4=self.GAT_encode(aa4_global, dd4_global, kk4, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_global_5"):        
            gatoutput_global5=self.GAT_encode(aa5_global, dd5_global, kk5, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_global_6"):        
            gatoutput_global6=self.GAT_encode(aa6_global, dd6_global, kk6, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_global_7"):        
            gatoutput_global7=self.GAT_encode(aa7_global, dd7_global, kk7, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_global_8"):        
            gatoutput_global8=self.GAT_encode(aa8_global, dd8_global, kk8, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        with tf.variable_scope("GAT_global_9"):        
            gatoutput_global9=self.GAT_encode(aa9_global, dd9_global, kk9, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
            
        gatoutput_global=self.flatten_emb_by_sentence(tf.concat([gatoutput_global1,gatoutput_global2,gatoutput_global3,gatoutput_global4,gatoutput_global5,gatoutput_global6,gatoutput_global7,gatoutput_global8,gatoutput_global9],0), text_len_mask) 
        ...
        #gate-filter
        gate_filter_inputs=tf.concat([context_outputs,gatoutput_all],1)      # #num_words,420        
        ...
        '''
        #lstm_gcnoutput=tf.concat([context_outputs,gatoutput],1) 
         
        KB_emb_tmp=tf.reshape(KB_emb,[num_sentences*max_sentence_length,200])   
        
        A_tmp=tf.reshape(adj_emb,[num_sentences,max_sentence_length,max_sentence_length])
        gatoutput=self.GAT_encode(A_tmp, KB_emb_tmp, text_len_mask,self.gat_dropout,self.n_attn_heads,self.GAToutsize)
        ...
        candidate_span_emb_print=tf.Print(candidate_span_emb, [ 'candidate_span_emb: ', candidate_span_emb[0], candidate_span_emb[2696], candidate_span_emb[3052], candidate_span_emb[3608], candidate_span_emb[3788], candidate_span_emb[4209], candidate_span_emb[13836], candidate_span_emb[20080], candidate_span_emb[21304], candidate_span_emb[23868], candidate_span_emb[99], candidate_span_emb[357], candidate_span_emb[914], candidate_span_emb[2011], candidate_span_emb[4924], candidate_span_emb[4935], candidate_span_emb[5144], candidate_span_emb[5280], candidate_span_emb[5587], candidate_span_emb[6142], candidate_span_emb[7547], candidate_span_emb[11127], candidate_span_emb[15027], candidate_span_emb[330], candidate_span_emb[1165], candidate_span_emb[1490], candidate_span_emb[2350], candidate_span_emb[2713], candidate_span_emb[2971], candidate_span_emb[3761], candidate_span_emb[4230], candidate_span_emb[7714], candidate_span_emb[7988], candidate_span_emb[10664], candidate_span_emb[11200], candidate_span_emb[12289], candidate_span_emb[12709], candidate_span_emb[12901], candidate_span_emb[13575], candidate_span_emb[13799], candidate_span_emb[13854], candidate_span_emb[14221], candidate_span_emb[14487], candidate_span_emb[14962], candidate_span_emb[15246], candidate_span_emb[17509], candidate_span_emb[17902], candidate_span_emb[19612], candidate_span_emb[19692], candidate_span_emb[24181], candidate_span_emb[24622], candidate_span_emb[29702], candidate_span_emb[34315], candidate_span_emb[350], candidate_span_emb[1079], candidate_span_emb[1592], candidate_span_emb[3707], candidate_span_emb[3890], candidate_span_emb[4160], candidate_span_emb[4242], candidate_span_emb[4443], candidate_span_emb[4680], candidate_span_emb[10938], candidate_span_emb[11321], candidate_span_emb[11808], candidate_span_emb[12726], candidate_span_emb[13815], candidate_span_emb[16307], candidate_span_emb[352], candidate_span_emb[4933], candidate_span_emb[587], candidate_span_emb[5099], candidate_span_emb[13730], candidate_span_emb[642], candidate_span_emb[5252], candidate_span_emb[658], candidate_span_emb[675], candidate_span_emb[689], candidate_span_emb[5895], candidate_span_emb[6469], candidate_span_emb[6736], candidate_span_emb[7299], candidate_span_emb[8516], candidate_span_emb[11069], candidate_span_emb[15536], candidate_span_emb[16162], candidate_span_emb[18635], candidate_span_emb[22144], candidate_span_emb[1436], candidate_span_emb[12455], candidate_span_emb[14618], candidate_span_emb[1470], candidate_span_emb[1580], candidate_span_emb[12565], candidate_span_emb[13077], candidate_span_emb[13132], candidate_span_emb[14732], candidate_span_emb[1430], candidate_span_emb[12436], candidate_span_emb[13127], candidate_span_emb[14592], candidate_span_emb[1595], candidate_span_emb[13820], candidate_span_emb[2380], candidate_span_emb[2596], candidate_span_emb[2716], candidate_span_emb[2992], candidate_span_emb[4167], candidate_span_emb[13510], candidate_span_emb[15277], candidate_span_emb[16352], candidate_span_emb[16698], candidate_span_emb[16873], candidate_span_emb[16951], candidate_span_emb[17071], candidate_span_emb[17584], candidate_span_emb[29877], candidate_span_emb[2463], candidate_span_emb[13609], candidate_span_emb[19831], candidate_span_emb[25207], candidate_span_emb[2446], candidate_span_emb[13613], candidate_span_emb[2627], candidate_span_emb[2671], candidate_span_emb[2688], candidate_span_emb[2693], candidate_span_emb[2699], candidate_span_emb[2822], candidate_span_emb[2926], candidate_span_emb[2782], candidate_span_emb[29667], candidate_span_emb[2873], candidate_span_emb[2979], candidate_span_emb[9693], candidate_span_emb[18097], candidate_span_emb[18717], candidate_span_emb[26325], candidate_span_emb[34171], candidate_span_emb[3208], candidate_span_emb[3218], candidate_span_emb[7086], candidate_span_emb[3225], candidate_span_emb[3457], candidate_span_emb[3387], candidate_span_emb[3418], candidate_span_emb[3373], candidate_span_emb[3595], candidate_span_emb[3692], candidate_span_emb[3863], candidate_span_emb[3680], candidate_span_emb[3708], candidate_span_emb[4444], candidate_span_emb[3843], candidate_span_emb[3868], candidate_span_emb[4047], candidate_span_emb[4122], candidate_span_emb[4166], candidate_span_emb[4248], candidate_span_emb[19808], candidate_span_emb[28126], candidate_span_emb[4484], candidate_span_emb[4562], candidate_span_emb[4514], candidate_span_emb[4925], candidate_span_emb[5145], candidate_span_emb[11128], candidate_span_emb[4895], candidate_span_emb[5100], candidate_span_emb[7660], candidate_span_emb[26758], candidate_span_emb[27145], candidate_span_emb[32129], candidate_span_emb[32629], candidate_span_emb[33179], candidate_span_emb[7697], candidate_span_emb[7955], candidate_span_emb[8264], candidate_span_emb[8909], candidate_span_emb[9910], candidate_span_emb[10314], candidate_span_emb[19202], candidate_span_emb[8858], candidate_span_emb[10289], candidate_span_emb[19173], candidate_span_emb[9253], candidate_span_emb[26461], candidate_span_emb[9429], candidate_span_emb[22855]],summarize=3000000)   
        
        '''
        tsne = manifold.TSNE(n_components=2, init='pca', random_state=501)
        df_embedded = tsne.fit_transform(candidate_span_emb)
        df_embedded_print=tf.Print(df_embedded, [ 'df_embedded: ', df_embedded],summarize=300000)       
        tmpppp=tf.reshape(df_embedded_print,[-1])
        tf.print("df_embedded: ", df_embedded)
        '''
        
        #print(candidate_span_emb.get_shape().as_list() )
        
        candidate_mention_scores = self.get_mention_scores(
            candidate_span_emb_print)  # [k, 1]
        ...
        top_span_emb = tf.gather(
            candidate_span_emb_print, top_span_indices)  # [k, emb]
        ...
        tf.print("candidate_span_emb: ", candidate_span_emb[0], candidate_span_emb[2696], candidate_span_emb[3052], candidate_span_emb[3608], candidate_span_emb[3788], candidate_span_emb[4209], candidate_span_emb[13836], candidate_span_emb[20080], candidate_span_emb[21304], candidate_span_emb[23868], candidate_span_emb[99], candidate_span_emb[357], candidate_span_emb[914], candidate_span_emb[2011], candidate_span_emb[4924], candidate_span_emb[4935], candidate_span_emb[5144], candidate_span_emb[5280], candidate_span_emb[5587], candidate_span_emb[6142], candidate_span_emb[7547], candidate_span_emb[11127], candidate_span_emb[15027], candidate_span_emb[330], candidate_span_emb[1165], candidate_span_emb[1490], candidate_span_emb[2350], candidate_span_emb[2713], candidate_span_emb[2971], candidate_span_emb[3761], candidate_span_emb[4230], candidate_span_emb[7714], candidate_span_emb[7988], candidate_span_emb[10664], candidate_span_emb[11200], candidate_span_emb[12289], candidate_span_emb[12709], candidate_span_emb[12901], candidate_span_emb[13575], candidate_span_emb[13799], candidate_span_emb[13854], candidate_span_emb[14221], candidate_span_emb[14487], candidate_span_emb[14962], candidate_span_emb[15246], candidate_span_emb[17509], candidate_span_emb[17902], candidate_span_emb[19612], candidate_span_emb[19692], candidate_span_emb[24181], candidate_span_emb[24622], candidate_span_emb[29702], candidate_span_emb[34315], candidate_span_emb[350], candidate_span_emb[1079], candidate_span_emb[1592], candidate_span_emb[3707], candidate_span_emb[3890], candidate_span_emb[4160], candidate_span_emb[4242], candidate_span_emb[4443], candidate_span_emb[4680], candidate_span_emb[10938], candidate_span_emb[11321], candidate_span_emb[11808], candidate_span_emb[12726], candidate_span_emb[13815], candidate_span_emb[16307], candidate_span_emb[352], candidate_span_emb[4933], candidate_span_emb[587], candidate_span_emb[5099], candidate_span_emb[13730], candidate_span_emb[642], candidate_span_emb[5252], candidate_span_emb[658], candidate_span_emb[675], candidate_span_emb[689], candidate_span_emb[5895], candidate_span_emb[6469], candidate_span_emb[6736], candidate_span_emb[7299], candidate_span_emb[8516], candidate_span_emb[11069], candidate_span_emb[15536], candidate_span_emb[16162], candidate_span_emb[18635], candidate_span_emb[22144], candidate_span_emb[1436], candidate_span_emb[12455], candidate_span_emb[14618], candidate_span_emb[1470], candidate_span_emb[1580], candidate_span_emb[12565], candidate_span_emb[13077], candidate_span_emb[13132], candidate_span_emb[14732], candidate_span_emb[1430], candidate_span_emb[12436], candidate_span_emb[13127], candidate_span_emb[14592], candidate_span_emb[1595], candidate_span_emb[13820], candidate_span_emb[2380], candidate_span_emb[2596], candidate_span_emb[2716], candidate_span_emb[2992], candidate_span_emb[4167], candidate_span_emb[13510], candidate_span_emb[15277], candidate_span_emb[16352], candidate_span_emb[16698], candidate_span_emb[16873], candidate_span_emb[16951], candidate_span_emb[17071], candidate_span_emb[17584], candidate_span_emb[29877], candidate_span_emb[2463], candidate_span_emb[13609], candidate_span_emb[19831], candidate_span_emb[25207], candidate_span_emb[2446], candidate_span_emb[13613], candidate_span_emb[2627], candidate_span_emb[2671], candidate_span_emb[2688], candidate_span_emb[2693], candidate_span_emb[2699], candidate_span_emb[2822], candidate_span_emb[2926], candidate_span_emb[2782], candidate_span_emb[29667], candidate_span_emb[2873], candidate_span_emb[2979], candidate_span_emb[9693], candidate_span_emb[18097], candidate_span_emb[18717], candidate_span_emb[26325], candidate_span_emb[34171], candidate_span_emb[3208], candidate_span_emb[3218], candidate_span_emb[7086], candidate_span_emb[3225], candidate_span_emb[3457], candidate_span_emb[3387], candidate_span_emb[3418], candidate_span_emb[3373], candidate_span_emb[3595], candidate_span_emb[3692], candidate_span_emb[3863], candidate_span_emb[3680], candidate_span_emb[3708], candidate_span_emb[4444], candidate_span_emb[3843], candidate_span_emb[3868], candidate_span_emb[4047], candidate_span_emb[4122], candidate_span_emb[4166], candidate_span_emb[4248], candidate_span_emb[19808], candidate_span_emb[28126], candidate_span_emb[4484], candidate_span_emb[4562], candidate_span_emb[4514], candidate_span_emb[4925], candidate_span_emb[5145], candidate_span_emb[11128], candidate_span_emb[4895], candidate_span_emb[5100], candidate_span_emb[7660], candidate_span_emb[26758], candidate_span_emb[27145], candidate_span_emb[32129], candidate_span_emb[32629], candidate_span_emb[33179], candidate_span_emb[7697], candidate_span_emb[7955], candidate_span_emb[8264], candidate_span_emb[8909], candidate_span_emb[9910], candidate_span_emb[10314], candidate_span_emb[19202], candidate_span_emb[8858], candidate_span_emb[10289], candidate_span_emb[19173], candidate_span_emb[9253], candidate_span_emb[26461], candidate_span_emb[9429], candidate_span_emb[22855])
